...
public class DataRowLite {
    ...
    /**
     * The content string for this row of data; see DataRow.mIdea
     */
    public String mContent; // is this string needed?

        /**
     * The likes for this row of data; see DataRow.mLikes
     */
    public int mLikes;
    /**
